...
Using `git`:  
```sh
~ $ git clone --depth 1 --branch 18.11.9 https://github.com/Pouriya-Jahanbakhsh/tir && cd tir
~/tir $
```
Using `wget`:  
```sh
~ $ wget https://github.com/Pouriya-Jahanbakhsh/tir/archive/18.11.9.tar.gz && tar xf 18.11.9.tar.gz && cd tir-18.11.9
~/tir-18.11.9 $
```
