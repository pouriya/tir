...
Using `git`:  
```sh
~ $ git clone --depth 1 --branch 19.5.12 https://github.com/Pouriya-Jahanbakhsh/tir && cd tir
~/tir $
```
Using `wget`:  
```sh
~ $ wget https://github.com/Pouriya-Jahanbakhsh/tir/archive/19.5.12.tar.gz && tar xf 19.5.12.tar.gz && cd tir-19.5.12
~/tir-19.5.12 $
```
